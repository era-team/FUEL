...
namespace fast_planner
{
  ...
  public:
    ...
    int toAddress(double x, double y, double z);
    ...
    int getVoxelNum();
    void addVirtualWall(const Eigen::Vector3d center, const Eigen::Vector3d dimensions, const Eigen::Quaterniond orientation);
    void enableVirtualWalls();
    void disableVirtualWalls();
  ...
  private:
    ...
    void addWallToSdf(const VirtualWall &wall);
  ...
  inline int SDFMap::toAddress(double x, double y, double z)
  {
    int x_ = (int)((x - mp_->map_min_boundary_(0)) / mp_->resolution_);
    int y_ = (int)((y - mp_->map_min_boundary_(1)) / mp_->resolution_);
    int z_ = (int)((z - mp_->map_min_boundary_(2)) / mp_->resolution_);
    return toAddress(x_, y_, z_);
  }
